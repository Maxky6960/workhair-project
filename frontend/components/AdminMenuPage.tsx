                ...
                <tr key={item.id} style={{ borderBottom: "1px solid rgba(192,133,82,0.1)", backgroundColor: i % 2 === 0 ? "transparent" : "rgba(192,133,82,0.02)" }}>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <img src={item.image_url || "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=400&fit=crop"} alt={item.name} className="w-10 h-10 rounded-lg object-cover flex-shrink-0" />
